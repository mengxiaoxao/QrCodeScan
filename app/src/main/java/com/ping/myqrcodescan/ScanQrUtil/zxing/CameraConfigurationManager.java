...
package com.ping.myqrcodescan.ScanQrUtil.zxing;
...
final class CameraConfigurationManager {
  ...
  void initFromCameraParameters(com.ping.myqrcodescan.ScanQrUtil.zxing.OpenCamera camera, int width, int height) {
    ...
    if (camera.getFacing() == com.ping.myqrcodescan.ScanQrUtil.zxing.CameraFacing.FRONT) {
  ...
  void setDesiredCameraParameters(com.ping.myqrcodescan.ScanQrUtil.zxing.OpenCamera camera, boolean safeMode) {
